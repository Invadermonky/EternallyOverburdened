...
public class AttributeHandlerEO {
    ...
    public static final IAttribute CARRY_WEIGHT = new RangedAttribute(null,
            EternallyOverburdened.MOD_ID_SHORT + ":carryWeight",
    ...
    public static double getCarryWeight(EntityPlayer player) {
        ...
        if(attributeInstance != null && attributeInstance.getBaseValue() != ConfigHandlerEO.playerSettings.maxCarryWeight) {
            attributeInstance.setBaseValue(ConfigHandlerEO.playerSettings.maxCarryWeight);
        }
